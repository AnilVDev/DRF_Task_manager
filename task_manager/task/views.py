...
class TaskCreateListView(generics.ListCreateAPIView):
    ...
    def perform_create(self, serializer):
        try:
            ...
            raise ValidationError({"error": "Task creation failed. Please try again later."})
...
class TaskUpdateDeleteView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_object(self):
        try:
            ...
            raise ValidationError({"error":"An error occurred while retrieving the task.", "details": str(e)})
